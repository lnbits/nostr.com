          ...
          <div className='relative z-10 md:text-center lg:text-left'>
            ...
            <div className='relative'>
              ...
              <div className='mt-8 flex gap-4 md:justify-center lg:justify-start'>
                ...
                <button style='cursor: pointer;padding: 0;border: none;background:none;'>
                  <div style='float:left;background: #3ba1bc; padding:10px; border-radius: 50%;'>
                    ▶
                  </div>{' '}
                  <div style='float:right; padding:10px;'>What is nostr?</div>
                </button>
                <dialog style='border: 0'>
                  <iframe
                    ...
                    height='341'
                    type='text/html'
                    src='https://www.youtube.com/embed/5W-jtbbh3eA?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=http://youtubeembedcode.com'
                  ></iframe>
                </dialog>
                <script></script>
              </div>
